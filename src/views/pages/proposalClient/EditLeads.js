      ...
      axios.get(`${BASE_URL}editleadfollowup?id=${id}`)
        .then(response => {
          ...
          setFormData({
            ...
            PhotographerAssigned: data?.PhotographerAssigned ? data.PhotographerAssigned?.split(', ') : [],
...
const closeModel=()=>{
  ...
  <CForm onSubmit={handleSubmit} style={{padding:'15px'}} >
...
<CCol sm="3" className="mb-3">
     ...
     <CButton type="submit" color="danger">Update Lead</CButton>
