...
const validateEmail = (email) => {
  ...
  const handleSubmit = (e) => {
    ...
    formDataObj.append('EmpId', ConvertLoggedEmp.EmployeeId);
    formDataObj.append('EmpName', ConvertLoggedEmp.firstName);
  
    axios.post(`${BASE_URL}proposalclient`, formDataObj, {
